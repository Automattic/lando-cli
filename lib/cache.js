 ...
 * @property {Log} log Logger instance.
 * @property {string} cacheDir Directory used for file-backed cache entries.
 */
module.exports = class Cache extends NodeCache {
  /**
   * @param {object} [opts] Options to pass into the cache.
  * @param {Log} [opts.log] Logger instance.
   * @param {string} [opts.cacheDir] Directory used for file-backed cache entries.
   */
   ...
   * @param {unknown} data The data to store in the cache.
   * @param {object} [opts] Options to pass into the cache.
   * @param {boolean} [opts.persist] Whether this cache data should persist between processes.
   * @param {number} [opts.ttl] Seconds the cache should live; `0` means forever.
   * @example
   ...
   * @returns {unknown} The data stored in the cache if applicable.
   * @example
