...
/**
 * App config loaded from a Landofile plus bootstrap metadata.
 * @typedef {object} AppConfig
 * @property {object} [config] Recipe or service config overrides.
 * @property {string[]} [compose] Compose file paths.
 * @property {string[]} [env_file] Environment file paths.
 * @property {string[]} files Source config files.
 */

/**
 * Compose data group tracked on an app instance.
 * @typedef {object} ComposeGroup
 * @property {object[]} data Compose documents in this group.
 * @property {string} id Group identifier.
 * @property {object} [info] Extra metadata about the group.
 */

/**
 * @typedef {object} AppWarning
 * @property {string} title Warning title.
 * @property {string} [message] Warning details.
 * @property {string} [severity] Warning severity.
 */

/**
 * Initializes an app before a lifecycle operation continues.
 * @param {App} app App instance.
 * @param {string} [method] Lifecycle method name.
 * @returns {Promise<boolean>} Promise resolving after initialization.
 */
...
/**
 * Loads app plugins and merges their data onto the app.
 * @param {App} app App instance.
 * @param {import('./lando')} lando Lando instance.
 * @returns {Promise} Promise resolving after plugin data is merged.
 */
...
module.exports = class App {
  ...
  * @param {AppConfig} config Config for the app.
  * @param {import('./lando')} [lando] A Lando instance.
   */
  ...
  /**
   * Adds compose data to the app, optionally at the front of the list.
    * @param {ComposeGroup} data Compose fragment to add.
   * @param {boolean} [front] Whether to prepend instead of append.
  ...
  /**
   * Records a warning or error on the app and updates the exit code when needed.
   * @param {AppWarning} message Warning payload.
   * @param {Error|string|null} [error] Optional backing error.
   * @returns {void} No return value.
   */
  ...
  /**
   * Resets cached initialization state.
   * @returns {void} No return value.
   */
  reset() {
   ...
   * @fires pre_uninstall
   * @fires post_uninstall
   * @param {boolean} purge Whether to remove persistent resources as well.
   * @returns {Promise} A promise.
   */
  ...
  /**
   * Gets the default container id for a service.
   * @param {string} service Service name.
   * @returns {string} Docker Compose container id.
   */
  ...
  /**
   * Resolves a service name from a Compose container id.
