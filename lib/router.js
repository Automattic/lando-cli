 ...
 * @returns {object} Cloned task data without incompatible run options.
 */
 ...
 * @param {object|object[]} data Engine task data.
 * @param {function(object): Promise} run Operation to run for each datum.
 ...
 * @param {object} daemon Daemon controller.
 * @param {object} events Event emitter.
 * @param {object|object[]} data Engine task data.
 * @param {function(object|object[]): Promise} run Action callback.
 ...
 * @param {object|object[]} data Compose task data.
 * @param {function(string, object): Promise} compose Compose command runner.
 ...
 * @param {object|object[]} data Engine task data.
 * @param {function(string, object): Promise} compose Compose command runner.
 * @param {object} docker Docker client wrapper.
 ...
 * @param {object} data Engine task data.
 * @param {function(string, object): Promise} compose Compose command runner.
 * @param {object} docker Docker client wrapper.
